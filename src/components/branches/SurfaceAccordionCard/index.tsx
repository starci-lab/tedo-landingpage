...
/**
 * BRANCH - `SurfaceAccordionCard`: the `labelled-surface-section` grammar, projected into one
 ...
 * SurfaceCard-family branches is the GRAMMAR, not which side of the vendor boundary each slot lands.
 *
