                    ...
                    <span aria-hidden={shouldAnimate ? true : undefined}>
                        <ReactMarkdown
                            ...
                            components={{
                                ...
                                table: (p) => (
                                    <table className="my-4 w-full min-w-markdown-table border-collapse text-left text-xs sm:text-sm">{p.children}</table>
                                ),
